...
{
	if (!loongson_cpu_has_ppb || !support_boost()) {
...
static int __init loongson3_cpufreq_init(void)
{
	...
	/*
	 * This cpufreq driver is based on ACPI and related
	 * entries in DSDT.
	 *
	 * And this driver ONLY support LOONGSON 3A4000
	 * compatible cpus with loongson_cpu_has_pps flag.
	 * */
	if (!loongson_cpu_has_pps)
		return -ENODEV;
