...
#define LOONGSON_CPU_PPS	MBIT_ULL( 8)	/* CPU supports processor performance scaling */
#define LOONGSON_CPU_PPB	MBIT_ULL( 9)	/* CPU supports processor performance boost */
...
#ifndef loongson_cpu_has_pps
# define loongson_cpu_has_pps		__loongson_opt(LOONGSON_CPU_PPS)
#endif

#ifndef loongson_cpu_has_ppb
# define loongson_cpu_has_ppb		__loongson_opt(LOONGSON_CPU_PPB)
#endif
