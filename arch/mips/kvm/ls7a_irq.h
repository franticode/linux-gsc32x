...
static inline void ls7a_update_read_page_long(struct ls7a_kvm_ioapic *s,
					 unsigned int addr, unsigned long value)
{
	*(unsigned long *)(s->read_page_address + addr) = value;
}
static inline void ls7a_update_read_page_char(struct ls7a_kvm_ioapic *s,
					 unsigned int addr, unsigned char value)
{
